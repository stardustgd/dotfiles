#!/bin/bash
# Script from https://gitlab.com/Nmoleo/i3-volume-brightness-indicator
...
case $1 in
    ...
    low_brightness_up)
    # Increases brightness by 1 and displays the notification
    brightnessctl set 1%+
    show_brightness_notif
    ;;

    low_brightness_down)
    # Decreases brightness by 1 and displays the notification
    brightnessctl set 1%-
    show_brightness_notif
    ;;
